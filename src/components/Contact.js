...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-richBlack">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          ...
          <div className="relative mb-4">
            <label htmlFor="email" className="leading-7 text-sm text-lightGrey">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="relative mb-4">
            <label
              htmlFor="message"
              className="leading-7 text-sm text-lightGrey">
              Message
            </label>
            <textarea
              id="message"
          ...
          <button
            type="submit"
            className="text-goldGolden bg-oxfordBlue border-0 py-2 px-6 focus:outline-none hover:bg-prussianBlue rounded text-lg">
            Submit
          </button>
        </form>
